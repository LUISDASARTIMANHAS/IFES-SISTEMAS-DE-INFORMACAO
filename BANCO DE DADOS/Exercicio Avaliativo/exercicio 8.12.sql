...
-- Tem 2.539.055 filmes. Ordenado pela “dat_locacao desc” e “cod_fita”. Vou listar os
-- 5 primeiros:
-- select
-- 	fil.cod_filme
-- ,	fil.nom_filme
...
from
	fita f
	left join locacao l on f.cod_fita = l.cod_fita
	join filme flm on flm.cod_filme = f.cod_filme
order by
	l.dat_locacao desc,
	f.cod_fita